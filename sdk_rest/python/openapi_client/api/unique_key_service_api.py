...
class UniqueKeyServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.unique_key_service_disable_unique_key_endpoint = _Endpoint(
            settings={
                'response_type': (TitaniumAcknowledgeResponse,),
                'auth': [],
                'endpoint_path': '/api/v1/uniquekey/disable',
                'operation_id': 'unique_key_service_disable_unique_key',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.unique_key_service_enable_unique_key_endpoint = _Endpoint(
            settings={
                'response_type': (TitaniumAcknowledgeResponse,),
                'auth': [],
                'endpoint_path': '/api/v1/uniquekey/enable',
                'operation_id': 'unique_key_service_enable_unique_key',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def unique_key_service_disable_unique_key(
        self,
        body,
        **kwargs
    ):
        ...
        kwargs['body'] = \
            body
        return self.unique_key_service_disable_unique_key_endpoint.call_with_http_info(**kwargs)

    def unique_key_service_enable_unique_key(
        self,
        body,
        **kwargs
    ):
        ...
        kwargs['body'] = \
            body
        return self.unique_key_service_enable_unique_key_endpoint.call_with_http_info(**kwargs)
