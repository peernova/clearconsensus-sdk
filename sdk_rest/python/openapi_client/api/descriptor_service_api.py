...
class DescriptorServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.descriptor_service_descriptor_dependencies_endpoint = _Endpoint(
            settings={
                'response_type': (TitaniumDescriptorDependenciesResponse,),
                'auth': [],
                'endpoint_path': '/api/v1/descriptor/dependencies',
                'operation_id': 'descriptor_service_descriptor_dependencies',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def descriptor_service_descriptor_dependencies(
        self,
        body,
        **kwargs
    ):
        ...
        kwargs['body'] = \
            body
        return self.descriptor_service_descriptor_dependencies_endpoint.call_with_http_info(**kwargs)
