...
class DbDescriptorServiceApi(object):
    ...
    def db_descriptor_service_descriptor_dependencies(self, body, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.db_descriptor_service_descriptor_dependencies_with_http_info(body, **kwargs)  # noqa: E501

    def db_descriptor_service_descriptor_dependencies_with_http_info(self, body, **kwargs):  # noqa: E501
        """db_descriptor_service_descriptor_dependencies  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.db_descriptor_service_descriptor_dependencies_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method db_descriptor_service_descriptor_dependencies" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and local_var_params.get('body') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `db_descriptor_service_descriptor_dependencies`")  # noqa: E501
