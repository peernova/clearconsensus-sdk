...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumRunCalculatorRequest();
  });
  ...
  describe('TitaniumRunCalculatorRequest', function() {
    it('should create an instance of TitaniumRunCalculatorRequest', function() {
      // uncomment below and update the code to test TitaniumRunCalculatorRequest
      //var instance = new ClearconsensusSdk.TitaniumRunCalculatorRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumRunCalculatorRequest);
    });
    ...
    it('should have the property consensusRunReason (base name: "consensusRunReason")', function() {
      // uncomment below and update the code to test the property consensusRunReason
      //var instance = new ClearconsensusSdk.TitaniumRunCalculatorRequest();
      //expect(instance).to.be();
    });
