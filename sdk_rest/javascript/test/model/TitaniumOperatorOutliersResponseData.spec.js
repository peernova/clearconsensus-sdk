...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumOperatorOutliersResponseData();
  });
  ...
  describe('TitaniumOperatorOutliersResponseData', function() {
    it('should create an instance of TitaniumOperatorOutliersResponseData', function() {
      // uncomment below and update the code to test TitaniumOperatorOutliersResponseData
      //var instance = new ClearconsensusSdk.TitaniumOperatorOutliersResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumOperatorOutliersResponseData);
    });
