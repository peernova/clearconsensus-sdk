...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumEvpExplorerTableColumn();
  });
  ...
  describe('TitaniumEvpExplorerTableColumn', function() {
    it('should create an instance of TitaniumEvpExplorerTableColumn', function() {
      // uncomment below and update the code to test TitaniumEvpExplorerTableColumn
      //var instance = new ClearconsensusSdk.TitaniumEvpExplorerTableColumn();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumEvpExplorerTableColumn);
    });
