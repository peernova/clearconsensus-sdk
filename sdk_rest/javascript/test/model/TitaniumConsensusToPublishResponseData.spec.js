...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumConsensusToPublishResponseData();
  });
  ...
  describe('TitaniumConsensusToPublishResponseData', function() {
    it('should create an instance of TitaniumConsensusToPublishResponseData', function() {
      // uncomment below and update the code to test TitaniumConsensusToPublishResponseData
      //var instance = new ClearconsensusSdk.TitaniumConsensusToPublishResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumConsensusToPublishResponseData);
    });
