...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumUploadURLRequest();
  });
  ...
  describe('TitaniumUploadURLRequest', function() {
    it('should create an instance of TitaniumUploadURLRequest', function() {
      // uncomment below and update the code to test TitaniumUploadURLRequest
      //var instance = new ClearconsensusSdk.TitaniumUploadURLRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumUploadURLRequest);
    });
