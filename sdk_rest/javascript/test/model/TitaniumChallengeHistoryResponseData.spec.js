...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumChallengeHistoryResponseData();
  });
  ...
  describe('TitaniumChallengeHistoryResponseData', function() {
    it('should create an instance of TitaniumChallengeHistoryResponseData', function() {
      // uncomment below and update the code to test TitaniumChallengeHistoryResponseData
      //var instance = new ClearconsensusSdk.TitaniumChallengeHistoryResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumChallengeHistoryResponseData);
    });
