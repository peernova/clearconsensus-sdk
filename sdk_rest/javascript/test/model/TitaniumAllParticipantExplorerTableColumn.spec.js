...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumAllParticipantExplorerTableColumn();
  });
  ...
  describe('TitaniumAllParticipantExplorerTableColumn', function() {
    it('should create an instance of TitaniumAllParticipantExplorerTableColumn', function() {
      // uncomment below and update the code to test TitaniumAllParticipantExplorerTableColumn
      //var instance = new ClearconsensusSdk.TitaniumAllParticipantExplorerTableColumn();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumAllParticipantExplorerTableColumn);
    });
    ...
    it('should have the property consensusPrice (base name: "consensusPrice")', function() {
      // uncomment below and update the code to test the property consensusPrice
      //var instance = new ClearconsensusSdk.TitaniumAllParticipantExplorerTableColumn();
      //expect(instance).to.be();
    });
