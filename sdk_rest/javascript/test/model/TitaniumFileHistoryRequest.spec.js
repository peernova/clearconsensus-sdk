...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumFileHistoryRequest();
  });
  ...
  describe('TitaniumFileHistoryRequest', function() {
    it('should create an instance of TitaniumFileHistoryRequest', function() {
      // uncomment below and update the code to test TitaniumFileHistoryRequest
      //var instance = new ClearconsensusSdk.TitaniumFileHistoryRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumFileHistoryRequest);
    });
    ...
    it('should have the property fileDate (base name: "fileDate")', function() {
