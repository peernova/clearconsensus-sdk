...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumTableRequest();
  });
  ...
  describe('TitaniumTableRequest', function() {
    it('should create an instance of TitaniumTableRequest', function() {
      // uncomment below and update the code to test TitaniumTableRequest
      //var instance = new ClearconsensusSdk.TitaniumTableRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumTableRequest);
    });
