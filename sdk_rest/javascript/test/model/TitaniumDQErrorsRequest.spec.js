...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumDQErrorsRequest();
  });
  ...
  describe('TitaniumDQErrorsRequest', function() {
    it('should create an instance of TitaniumDQErrorsRequest', function() {
      // uncomment below and update the code to test TitaniumDQErrorsRequest
      //var instance = new ClearconsensusSdk.TitaniumDQErrorsRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumDQErrorsRequest);
    });
