...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumTable();
  });
  ...
  describe('TitaniumTable', function() {
    it('should create an instance of TitaniumTable', function() {
      // uncomment below and update the code to test TitaniumTable
      //var instance = new ClearconsensusSdk.TitaniumTable();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumTable);
    });
