...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumChallengeHistoryRequest();
  });
  ...
  describe('TitaniumChallengeHistoryRequest', function() {
    it('should create an instance of TitaniumChallengeHistoryRequest', function() {
      // uncomment below and update the code to test TitaniumChallengeHistoryRequest
      //var instance = new ClearconsensusSdk.TitaniumChallengeHistoryRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumChallengeHistoryRequest);
    });
