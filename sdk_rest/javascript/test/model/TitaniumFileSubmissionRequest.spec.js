...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumFileSubmissionRequest();
  });
  ...
  describe('TitaniumFileSubmissionRequest', function() {
    it('should create an instance of TitaniumFileSubmissionRequest', function() {
      // uncomment below and update the code to test TitaniumFileSubmissionRequest
      //var instance = new ClearconsensusSdk.TitaniumFileSubmissionRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumFileSubmissionRequest);
    });
