...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumFileHistoryResponseData();
  });
  ...
  describe('TitaniumFileHistoryResponseData', function() {
    it('should create an instance of TitaniumFileHistoryResponseData', function() {
      // uncomment below and update the code to test TitaniumFileHistoryResponseData
      //var instance = new ClearconsensusSdk.TitaniumFileHistoryResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumFileHistoryResponseData);
    });
