...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumSubmittedRequest();
  });
  ...
  describe('TitaniumSubmittedRequest', function() {
    it('should create an instance of TitaniumSubmittedRequest', function() {
      // uncomment below and update the code to test TitaniumSubmittedRequest
      //var instance = new ClearconsensusSdk.TitaniumSubmittedRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumSubmittedRequest);
    });
