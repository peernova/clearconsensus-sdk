...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumCompleteDataUploadRequest();
  });
  ...
  describe('TitaniumCompleteDataUploadRequest', function() {
    it('should create an instance of TitaniumCompleteDataUploadRequest', function() {
      // uncomment below and update the code to test TitaniumCompleteDataUploadRequest
      //var instance = new ClearconsensusSdk.TitaniumCompleteDataUploadRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumCompleteDataUploadRequest);
    });
