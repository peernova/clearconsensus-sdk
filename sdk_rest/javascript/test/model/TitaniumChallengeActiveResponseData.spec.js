...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumChallengeActiveResponseData();
  });
  ...
  describe('TitaniumChallengeActiveResponseData', function() {
    it('should create an instance of TitaniumChallengeActiveResponseData', function() {
      // uncomment below and update the code to test TitaniumChallengeActiveResponseData
      //var instance = new ClearconsensusSdk.TitaniumChallengeActiveResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumChallengeActiveResponseData);
    });
