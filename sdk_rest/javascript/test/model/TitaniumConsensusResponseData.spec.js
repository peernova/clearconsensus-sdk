...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumConsensusResponseData();
  });
  ...
  describe('TitaniumConsensusResponseData', function() {
    it('should create an instance of TitaniumConsensusResponseData', function() {
      // uncomment below and update the code to test TitaniumConsensusResponseData
      //var instance = new ClearconsensusSdk.TitaniumConsensusResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumConsensusResponseData);
    });
