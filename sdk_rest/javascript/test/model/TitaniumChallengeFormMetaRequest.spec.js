...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumChallengeFormMetaRequest();
  });
  ...
  describe('TitaniumChallengeFormMetaRequest', function() {
    it('should create an instance of TitaniumChallengeFormMetaRequest', function() {
      // uncomment below and update the code to test TitaniumChallengeFormMetaRequest
      //var instance = new ClearconsensusSdk.TitaniumChallengeFormMetaRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumChallengeFormMetaRequest);
    });
