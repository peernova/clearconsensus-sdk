...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumRange();
  });
  ...
  describe('TitaniumRange', function() {
    it('should create an instance of TitaniumRange', function() {
      // uncomment below and update the code to test TitaniumRange
      //var instance = new ClearconsensusSdk.TitaniumRange();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumRange);
    });
