...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumChartsCurrenciesRequest();
  });
  ...
  describe('TitaniumChartsCurrenciesRequest', function() {
    it('should create an instance of TitaniumChartsCurrenciesRequest', function() {
      // uncomment below and update the code to test TitaniumChartsCurrenciesRequest
      //var instance = new ClearconsensusSdk.TitaniumChartsCurrenciesRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumChartsCurrenciesRequest);
    });
