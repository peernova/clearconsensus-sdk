...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumConsensusTabRequest();
  });
  ...
  describe('TitaniumConsensusTabRequest', function() {
    it('should create an instance of TitaniumConsensusTabRequest', function() {
      // uncomment below and update the code to test TitaniumConsensusTabRequest
      //var instance = new ClearconsensusSdk.TitaniumConsensusTabRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumConsensusTabRequest);
    });
