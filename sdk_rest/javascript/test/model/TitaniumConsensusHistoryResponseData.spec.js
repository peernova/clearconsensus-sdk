...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumConsensusHistoryResponseData();
  });
  ...
  describe('TitaniumConsensusHistoryResponseData', function() {
    it('should create an instance of TitaniumConsensusHistoryResponseData', function() {
      // uncomment below and update the code to test TitaniumConsensusHistoryResponseData
      //var instance = new ClearconsensusSdk.TitaniumConsensusHistoryResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumConsensusHistoryResponseData);
    });
