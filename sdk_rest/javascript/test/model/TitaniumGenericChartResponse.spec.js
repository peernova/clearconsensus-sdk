...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumGenericChartResponse();
  });
  ...
  describe('TitaniumGenericChartResponse', function() {
    it('should create an instance of TitaniumGenericChartResponse', function() {
      // uncomment below and update the code to test TitaniumGenericChartResponse
      //var instance = new ClearconsensusSdk.TitaniumGenericChartResponse();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumGenericChartResponse);
    });
