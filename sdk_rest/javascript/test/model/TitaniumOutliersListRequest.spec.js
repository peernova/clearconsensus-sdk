...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumOutliersListRequest();
  });
  ...
  describe('TitaniumOutliersListRequest', function() {
    it('should create an instance of TitaniumOutliersListRequest', function() {
      // uncomment below and update the code to test TitaniumOutliersListRequest
      //var instance = new ClearconsensusSdk.TitaniumOutliersListRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumOutliersListRequest);
    });
