...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumEVPRequest();
  });
  ...
  describe('TitaniumEVPRequest', function() {
    it('should create an instance of TitaniumEVPRequest', function() {
      // uncomment below and update the code to test TitaniumEVPRequest
      //var instance = new ClearconsensusSdk.TitaniumEVPRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumEVPRequest);
    });
