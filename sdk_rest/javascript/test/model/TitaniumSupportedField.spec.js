...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumSupportedField();
  });
  ...
  describe('TitaniumSupportedField', function() {
    it('should create an instance of TitaniumSupportedField', function() {
      // uncomment below and update the code to test TitaniumSupportedField
      //var instance = new ClearconsensusSdk.TitaniumSupportedField();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumSupportedField);
    });
    ...
    it('should have the property matchPattern (base name: "matchPattern")', function() {
      // uncomment below and update the code to test the property matchPattern
      //var instance = new ClearconsensusSdk.TitaniumSupportedField();
      //expect(instance).to.be();
    });
