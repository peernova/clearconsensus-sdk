...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumChallengeListResponseData();
  });
  ...
  describe('TitaniumChallengeListResponseData', function() {
    it('should create an instance of TitaniumChallengeListResponseData', function() {
      // uncomment below and update the code to test TitaniumChallengeListResponseData
      //var instance = new ClearconsensusSdk.TitaniumChallengeListResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumChallengeListResponseData);
    });
