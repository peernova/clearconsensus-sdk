...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumUsage();
  });
  ...
  describe('TitaniumUsage', function() {
    it('should create an instance of TitaniumUsage', function() {
      // uncomment below and update the code to test TitaniumUsage
      //var instance = new ClearconsensusSdk.TitaniumUsage();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumUsage);
    });
