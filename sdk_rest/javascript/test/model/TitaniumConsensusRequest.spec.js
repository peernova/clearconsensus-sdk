...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumConsensusRequest();
  });
  ...
  describe('TitaniumConsensusRequest', function() {
    it('should create an instance of TitaniumConsensusRequest', function() {
      // uncomment below and update the code to test TitaniumConsensusRequest
      //var instance = new ClearconsensusSdk.TitaniumConsensusRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumConsensusRequest);
    });
