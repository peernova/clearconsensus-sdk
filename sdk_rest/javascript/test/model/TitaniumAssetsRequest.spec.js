...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumAssetsRequest();
  });
  ...
  describe('TitaniumAssetsRequest', function() {
    it('should create an instance of TitaniumAssetsRequest', function() {
      // uncomment below and update the code to test TitaniumAssetsRequest
      //var instance = new ClearconsensusSdk.TitaniumAssetsRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumAssetsRequest);
    });
