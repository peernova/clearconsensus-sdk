...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumSupportedFieldsValues();
  });
  ...
  describe('TitaniumSupportedFieldsValues', function() {
    it('should create an instance of TitaniumSupportedFieldsValues', function() {
      // uncomment below and update the code to test TitaniumSupportedFieldsValues
      //var instance = new ClearconsensusSdk.TitaniumSupportedFieldsValues();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumSupportedFieldsValues);
    });
