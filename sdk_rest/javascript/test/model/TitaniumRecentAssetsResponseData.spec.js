...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumRecentAssetsResponseData();
  });
  ...
  describe('TitaniumRecentAssetsResponseData', function() {
    it('should create an instance of TitaniumRecentAssetsResponseData', function() {
      // uncomment below and update the code to test TitaniumRecentAssetsResponseData
      //var instance = new ClearconsensusSdk.TitaniumRecentAssetsResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumRecentAssetsResponseData);
    });
