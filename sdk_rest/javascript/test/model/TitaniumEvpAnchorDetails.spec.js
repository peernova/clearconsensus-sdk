...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumEvpAnchorDetails();
  });
  ...
  describe('TitaniumEvpAnchorDetails', function() {
    it('should create an instance of TitaniumEvpAnchorDetails', function() {
      // uncomment below and update the code to test TitaniumEvpAnchorDetails
      //var instance = new ClearconsensusSdk.TitaniumEvpAnchorDetails();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumEvpAnchorDetails);
    });
