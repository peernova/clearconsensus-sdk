...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumOutliersResponseData();
  });
  ...
  describe('TitaniumOutliersResponseData', function() {
    it('should create an instance of TitaniumOutliersResponseData', function() {
      // uncomment below and update the code to test TitaniumOutliersResponseData
      //var instance = new ClearconsensusSdk.TitaniumOutliersResponseData();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumOutliersResponseData);
    });
