...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumFileIdentifier();
  });
  ...
  describe('TitaniumFileIdentifier', function() {
    it('should create an instance of TitaniumFileIdentifier', function() {
      // uncomment below and update the code to test TitaniumFileIdentifier
      //var instance = new ClearconsensusSdk.TitaniumFileIdentifier();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumFileIdentifier);
    });
