...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumArgument();
  });
  ...
  describe('TitaniumArgument', function() {
    it('should create an instance of TitaniumArgument', function() {
      // uncomment below and update the code to test TitaniumArgument
      //var instance = new ClearconsensusSdk.TitaniumArgument();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumArgument);
    });
