...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumPopUpViewRequest();
  });
  ...
  describe('TitaniumPopUpViewRequest', function() {
    it('should create an instance of TitaniumPopUpViewRequest', function() {
      // uncomment below and update the code to test TitaniumPopUpViewRequest
      //var instance = new ClearconsensusSdk.TitaniumPopUpViewRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumPopUpViewRequest);
    });
