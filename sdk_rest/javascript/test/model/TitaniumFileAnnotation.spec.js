...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumFileAnnotation();
  });
  ...
  describe('TitaniumFileAnnotation', function() {
    it('should create an instance of TitaniumFileAnnotation', function() {
      // uncomment below and update the code to test TitaniumFileAnnotation
      //var instance = new ClearconsensusSdk.TitaniumFileAnnotation();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumFileAnnotation);
    });
