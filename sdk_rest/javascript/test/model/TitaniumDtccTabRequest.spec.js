...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.TitaniumDtccTabRequest();
  });
  ...
  describe('TitaniumDtccTabRequest', function() {
    it('should create an instance of TitaniumDtccTabRequest', function() {
      // uncomment below and update the code to test TitaniumDtccTabRequest
      //var instance = new ClearconsensusSdk.TitaniumDtccTabRequest();
      //expect(instance).to.be.a(ClearconsensusSdk.TitaniumDtccTabRequest);
    });
    ...
    it('should have the property snapDate (base name: "snapDate")', function() {
      // uncomment below and update the code to test the property snapDate
      //var instance = new ClearconsensusSdk.TitaniumDtccTabRequest();
      //expect(instance).to.be();
    });
