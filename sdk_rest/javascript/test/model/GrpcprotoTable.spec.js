...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ClearconsensusSdk.GrpcprotoTable();
  });
  ...
  describe('GrpcprotoTable', function() {
    it('should create an instance of GrpcprotoTable', function() {
      // uncomment below and update the code to test GrpcprotoTable
      //var instance = new ClearconsensusSdk.GrpcprotoTable();
      //expect(instance).to.be.a(ClearconsensusSdk.GrpcprotoTable);
    });
