...
class ConsensusServicePrivateStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ConsensusActive = channel.unary_unary('/titanium.ConsensusServicePrivate/ConsensusActive', request_serializer=common_dot_consensus__pb2.ConsensusActiveRequest.SerializeToString, response_deserializer=common_dot_gateway__base__pb2.ConsensusActiveResponse.FromString)
        self.ConsensusToPublish = channel.unary_unary('/titanium.ConsensusServicePrivate/ConsensusToPublish', request_serializer=common_dot_consensus__pb2.ConsensusToPublishRequest.SerializeToString, response_deserializer=common_dot_consensus__pb2.ConsensusToPublishResponse.FromString)
        self.ConsensusPublish = channel.unary_unary('/titanium.ConsensusServicePrivate/ConsensusPublish', request_serializer=common_dot_consensus__pb2.ConsensusPublishRequest.SerializeToString, response_deserializer=common_dot_gateway__base__pb2.MessageResponse.FromString)
        self.ConsensusHistory = channel.unary_unary('/titanium.ConsensusServicePrivate/ConsensusHistory', request_serializer=common_dot_consensus__pb2.ConsensusHistoryRequest.SerializeToString, response_deserializer=common_dot_consensus__pb2.ConsensusHistoryResponse.FromString)
        self.ConsensusDecision = channel.unary_unary('/titanium.ConsensusServicePrivate/ConsensusDecision', request_serializer=common_dot_consensus__pb2.ConsensusDecisionRequest.SerializeToString, response_deserializer=common_dot_gateway__base__pb2.MessageResponse.FromString)
...
class ConsensusServicePrivate(object):
    ...
    def ConsensusActive(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.ConsensusServicePrivate/ConsensusActive', common_dot_consensus__pb2.ConsensusActiveRequest.SerializeToString, common_dot_gateway__base__pb2.ConsensusActiveResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ConsensusToPublish(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.ConsensusServicePrivate/ConsensusToPublish', common_dot_consensus__pb2.ConsensusToPublishRequest.SerializeToString, common_dot_consensus__pb2.ConsensusToPublishResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ConsensusHistory(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.ConsensusServicePrivate/ConsensusHistory', common_dot_consensus__pb2.ConsensusHistoryRequest.SerializeToString, common_dot_consensus__pb2.ConsensusHistoryResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ConsensusDecision(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.ConsensusServicePrivate/ConsensusDecision', common_dot_consensus__pb2.ConsensusDecisionRequest.SerializeToString, common_dot_gateway__base__pb2.MessageResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)