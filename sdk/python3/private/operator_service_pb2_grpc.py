...
class OperatorServicePrivateStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadDTCC = channel.unary_unary('/titanium.OperatorServicePrivate/UploadDTCC', request_serializer=private_dot_operator__service__pb2.UploadDTCCRequest.SerializeToString, response_deserializer=common_dot_gateway__base__pb2.UploadURLResponse.FromString)
...
class OperatorServicePrivate(object):
    ...
    def UploadDTCC(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.OperatorServicePrivate/UploadDTCC', private_dot_operator__service__pb2.UploadDTCCRequest.SerializeToString, common_dot_gateway__base__pb2.UploadURLResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)