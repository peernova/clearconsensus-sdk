...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DATASERVICE.methods_by_name['UploadData']._options = None
    _DATASERVICE.methods_by_name['UploadData']._serialized_options = b'\x82\xd3\xe4\x93\x02\x18"\x13/api/v1/upload/data:\x01*'
    _DATASERVICE.methods_by_name['CompleteDataUpload']._options = None
    _DATASERVICE.methods_by_name['CompleteDataUpload']._serialized_options = b'\x82\xd3\xe4\x93\x02\x18"\x13/api/v1/upload/done:\x01*'
    _DATASERVICE._serialized_start = 116
    _DATASERVICE._serialized_end = 902