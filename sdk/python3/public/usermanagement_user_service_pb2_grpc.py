...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getById = channel.unary_unary('/com.peernova.titanium.casbin.management.grpc.service.UserService/getById', request_serializer=common_dot_usermanagement__user__pb2.UserId.SerializeToString, response_deserializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString)
        self.getAll = channel.unary_unary('/com.peernova.titanium.casbin.management.grpc.service.UserService/getAll', request_serializer=common_dot_usermanagement__user__pb2.UserEnabled.SerializeToString, response_deserializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString)
