...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddUser = channel.unary_unary('/titanium.UserService/AddUser', request_serializer=common_dot_user__controller__pb2.UserRequest.SerializeToString, response_deserializer=common_dot_user__controller__pb2.UserResponse.FromString)
        self.UpdateUser = channel.unary_unary('/titanium.UserService/UpdateUser', request_serializer=common_dot_user__controller__pb2.UserRequest.SerializeToString, response_deserializer=common_dot_user__controller__pb2.UserResponse.FromString)
        self.DeleteUser = channel.unary_unary('/titanium.UserService/DeleteUser', request_serializer=common_dot_user__controller__pb2.UserRequest.SerializeToString, response_deserializer=common_dot_user__controller__pb2.UserResponse.FromString)
...
class UserService(object):
    ...
    def AddUser(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.UserService/AddUser', common_dot_user__controller__pb2.UserRequest.SerializeToString, common_dot_user__controller__pb2.UserResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DeleteUser(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.UserService/DeleteUser', common_dot_user__controller__pb2.UserRequest.SerializeToString, common_dot_user__controller__pb2.UserResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)