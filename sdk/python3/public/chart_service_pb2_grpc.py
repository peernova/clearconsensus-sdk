...
def add_ChartServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {'getChartData': grpc.unary_unary_rpc_method_handler(servicer.getChartData, request_deserializer=public_dot_chart__service__pb2.GetChartDataRequest.FromString, response_serializer=public_dot_chart__service__pb2.GetChartDataResponse.SerializeToString)}
