...
def add_AdminServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {'OnBoard': grpc.unary_unary_rpc_method_handler(servicer.OnBoard, request_deserializer=public_dot_admin__service__pb2.OnBoardRequest.FromString, response_serializer=common_dot_gateway__base__pb2.MessageResponse.SerializeToString), 'RunCalculator': grpc.unary_unary_rpc_method_handler(servicer.RunCalculator, request_deserializer=public_dot_admin__service__pb2.RunCalculatorRequest.FromString, response_serializer=common_dot_gateway__base__pb2.MessageResponse.SerializeToString), 'RunConsensus': grpc.unary_unary_rpc_method_handler(servicer.RunConsensus, request_deserializer=public_dot_admin__service__pb2.RunConsensusRequest.FromString, response_serializer=common_dot_gateway__base__pb2.MessageResponse.SerializeToString), 'UploadEvaluatedPrice': grpc.unary_unary_rpc_method_handler(servicer.UploadEvaluatedPrice, request_deserializer=public_dot_admin__service__pb2.UploadEvaluatedPriceRequest.FromString, response_serializer=common_dot_gateway__base__pb2.MessageResponse.SerializeToString)}
