...
class DescriptorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DescriptorDependencies = channel.unary_unary('/titanium.DescriptorService/DescriptorDependencies', request_serializer=common_dot_gateway__base__pb2.GetDefinition.SerializeToString, response_deserializer=common_dot_descriptor__pb2.DescriptorDependenciesResponse.FromString)
...
class DescriptorServiceServicer(object):
    ...
    def DescriptorDependencies(self, request, context):
...
class DescriptorService(object):
    ...
    @staticmethod
    def DescriptorDependencies(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.DescriptorService/DescriptorDependencies', common_dot_gateway__base__pb2.GetDefinition.SerializeToString, common_dot_descriptor__pb2.DescriptorDependenciesResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
...
class DbDescriptorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DescriptorDependencies = channel.unary_unary('/titanium.DbDescriptorService/DescriptorDependencies', request_serializer=common_dot_gateway__base__pb2.GetDefinition.SerializeToString, response_deserializer=common_dot_descriptor__pb2.DescriptorDependenciesResponse.FromString)
...
class DbDescriptorService(object):
    ...
    @staticmethod
    def DescriptorDependencies(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.DbDescriptorService/DescriptorDependencies', common_dot_gateway__base__pb2.GetDefinition.SerializeToString, common_dot_descriptor__pb2.DescriptorDependenciesResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)