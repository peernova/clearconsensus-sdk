...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _UNIQUEKEYSERVICE.methods_by_name['EnableUniqueKey']._options = None
    _UNIQUEKEYSERVICE.methods_by_name['EnableUniqueKey']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1d"\x18/api/v1/uniquekey/enable:\x01*'
    _UNIQUEKEYSERVICE.methods_by_name['DisableUniqueKey']._options = None
    _UNIQUEKEYSERVICE.methods_by_name['DisableUniqueKey']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1e"\x19/api/v1/uniquekey/disable:\x01*'
    _UNIQUEKEYSERVICE._serialized_start = 128
    _UNIQUEKEYSERVICE._serialized_end = 994