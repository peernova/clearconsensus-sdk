...
RunConsensusRequest = _reflection.GeneratedProtocolMessageType('RunConsensusRequest', (_message.Message,), {'DESCRIPTOR': _RUNCONSENSUSREQUEST, '__module__': 'public.admin_service_pb2'})
_sym_db.RegisterMessage(RunConsensusRequest)
OnBoardRequest = _reflection.GeneratedProtocolMessageType('OnBoardRequest', (_message.Message,), {'DESCRIPTOR': _ONBOARDREQUEST, '__module__': 'public.admin_service_pb2'})
_sym_db.RegisterMessage(OnBoardRequest)
RunCalculatorRequest = _reflection.GeneratedProtocolMessageType('RunCalculatorRequest', (_message.Message,), {'DESCRIPTOR': _RUNCALCULATORREQUEST, '__module__': 'public.admin_service_pb2'})
_sym_db.RegisterMessage(RunCalculatorRequest)
UploadEvaluatedPriceRequest = _reflection.GeneratedProtocolMessageType('UploadEvaluatedPriceRequest', (_message.Message,), {'DESCRIPTOR': _UPLOADEVALUATEDPRICEREQUEST, '__module__': 'public.admin_service_pb2'})
_sym_db.RegisterMessage(UploadEvaluatedPriceRequest)
_ADMINSERVICE = DESCRIPTOR.services_by_name['AdminService']
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'\n com.peernova.titanium.interfacesB\x18AdminServiceProtoPrivateP\x01Z4github.com/peernova/clearconsensus-sdk/sdk/go/public'
    ...
    _RUNCONSENSUSREQUEST._serialized_start = 118
    _RUNCONSENSUSREQUEST._serialized_end = 230
    _ONBOARDREQUEST._serialized_start = 233
    _ONBOARDREQUEST._serialized_end = 363
    _RUNCALCULATORREQUEST._serialized_start = 366
    _RUNCALCULATORREQUEST._serialized_end = 509
    _UPLOADEVALUATEDPRICEREQUEST._serialized_start = 511
    _UPLOADEVALUATEDPRICEREQUEST._serialized_end = 625
    _ADMINSERVICE._serialized_start = 628
    _ADMINSERVICE._serialized_end = 1087