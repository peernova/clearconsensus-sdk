...
class PolicyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.create = channel.unary_unary('/com.peernova.titanium.casbin.management.grpc.service.PolicyService/create', request_serializer=common_dot_usermanagement__policy__pb2.Policies.SerializeToString, response_deserializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString)
        self.getPolicies = channel.unary_unary('/com.peernova.titanium.casbin.management.grpc.service.PolicyService/getPolicies', request_serializer=common_dot_usermanagement__policy__pb2.PolicyType.SerializeToString, response_deserializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString)
        self.removePolicy = channel.unary_unary('/com.peernova.titanium.casbin.management.grpc.service.PolicyService/removePolicy', request_serializer=common_dot_usermanagement__policy__pb2.PolicyDto.SerializeToString, response_deserializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString)
        self.checkPolicy = channel.unary_unary('/com.peernova.titanium.casbin.management.grpc.service.PolicyService/checkPolicy', request_serializer=common_dot_usermanagement__policy__pb2.PolicyDto.SerializeToString, response_deserializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString)
        self.getAssets = channel.unary_unary('/com.peernova.titanium.casbin.management.grpc.service.PolicyService/getAssets', request_serializer=common_dot_usermanagement__policy__pb2.UsernamePermissionRequest.SerializeToString, response_deserializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString)
...
def add_PolicyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {'create': grpc.unary_unary_rpc_method_handler(servicer.create, request_deserializer=common_dot_usermanagement__policy__pb2.Policies.FromString, response_serializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.SerializeToString), 'getPolicies': grpc.unary_unary_rpc_method_handler(servicer.getPolicies, request_deserializer=common_dot_usermanagement__policy__pb2.PolicyType.FromString, response_serializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.SerializeToString), 'removePolicy': grpc.unary_unary_rpc_method_handler(servicer.removePolicy, request_deserializer=common_dot_usermanagement__policy__pb2.PolicyDto.FromString, response_serializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.SerializeToString), 'checkPolicy': grpc.unary_unary_rpc_method_handler(servicer.checkPolicy, request_deserializer=common_dot_usermanagement__policy__pb2.PolicyDto.FromString, response_serializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.SerializeToString), 'getAssets': grpc.unary_unary_rpc_method_handler(servicer.getAssets, request_deserializer=common_dot_usermanagement__policy__pb2.UsernamePermissionRequest.FromString, response_serializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.SerializeToString), 'getApis': grpc.unary_unary_rpc_method_handler(servicer.getApis, request_deserializer=common_dot_usermanagement__policy__pb2.UsernamePermissionRequest.FromString, response_serializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.SerializeToString), 'getAddons': grpc.unary_unary_rpc_method_handler(servicer.getAddons, request_deserializer=common_dot_usermanagement__policy__pb2.UsernamePermissionRequest.FromString, response_serializer=common_dot_usermanagement__fe__specific__pb2.ServiceResponse.SerializeToString)}
...
class PolicyService(object):
    ...
    def getPolicies(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.peernova.titanium.casbin.management.grpc.service.PolicyService/getPolicies', common_dot_usermanagement__policy__pb2.PolicyType.SerializeToString, common_dot_usermanagement__fe__specific__pb2.ServiceResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
