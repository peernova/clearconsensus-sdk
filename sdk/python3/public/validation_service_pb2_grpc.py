...
class ValidatorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AddValidationRule = channel.unary_unary('/titanium.ValidatorService/AddValidationRule', request_serializer=common_dot_validation__pb2.ValidationRuleDefinition.SerializeToString, response_deserializer=common_dot_gateway__base__pb2.AcknowledgeResponse.FromString)
        self.GetValidationRule = channel.unary_unary('/titanium.ValidatorService/GetValidationRule', request_serializer=common_dot_gateway__base__pb2.GetDefinition.SerializeToString, response_deserializer=common_dot_validation__pb2.GetValidationRuleResponse.FromString)
        ...
        self.GetValidationRuleVersion = channel.unary_unary('/titanium.ValidatorService/GetValidationRuleVersion', request_serializer=common_dot_gateway__base__pb2.VersionRequest.SerializeToString, response_deserializer=common_dot_validation__pb2.GetValidationRuleResponse.FromString)
        self.GetGeneratedValidationRule = channel.unary_unary('/titanium.ValidatorService/GetGeneratedValidationRule', request_serializer=common_dot_gateway__base__pb2.GetDefinition.SerializeToString, response_deserializer=common_dot_validation__pb2.GetGeneratedValidationRuleResponse.FromString)
        ...
        self.GetGeneratedValidationRuleVersion = channel.unary_unary('/titanium.ValidatorService/GetGeneratedValidationRuleVersion', request_serializer=common_dot_gateway__base__pb2.VersionRequest.SerializeToString, response_deserializer=common_dot_validation__pb2.GetGeneratedValidationRuleResponse.FromString)
        self.RdlCheck = channel.unary_unary('/titanium.ValidatorService/RdlCheck', request_serializer=common_dot_validation__pb2.RdlCheckRequest.SerializeToString, response_deserializer=common_dot_gateway__base__pb2.MessageResponse.FromString)
...
class ValidatorService(object):
    ...
    def GetValidationRule(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.ValidatorService/GetValidationRule', common_dot_gateway__base__pb2.GetDefinition.SerializeToString, common_dot_validation__pb2.GetValidationRuleResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetGeneratedValidationRule(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.ValidatorService/GetGeneratedValidationRule', common_dot_gateway__base__pb2.GetDefinition.SerializeToString, common_dot_validation__pb2.GetGeneratedValidationRuleResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RdlCheck(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/titanium.ValidatorService/RdlCheck', common_dot_validation__pb2.RdlCheckRequest.SerializeToString, common_dot_gateway__base__pb2.MessageResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)