...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _CONSENSUSSERVICE.methods_by_name['EvaluatedPrice']._serialized_options = b'\x82\xd3\xe4\x93\x02&"!/api/v1/consensus/evaluated-price:\x01*'
    ...
    _CONSENSUSSERVICE._serialized_end = 922