...
_POPVIEWSTATUS = DESCRIPTOR.message_types_by_name['PopViewStatus']
...
PopViewStatus = _reflection.GeneratedProtocolMessageType('PopViewStatus', (_message.Message,), {'DESCRIPTOR': _POPVIEWSTATUS, '__module__': 'common.popup_pb2'})
_sym_db.RegisterMessage(PopViewStatus)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _POPVIEWSTATUS._serialized_start = 900
    _POPVIEWSTATUS._serialized_end = 1030