...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DESCRIPTORDEPENDENCIESRESPONSE._serialized_start = 719
    _DESCRIPTORDEPENDENCIESRESPONSE._serialized_end = 798