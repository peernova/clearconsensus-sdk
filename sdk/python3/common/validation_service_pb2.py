...
ValidationRuleDefinition = _reflection.GeneratedProtocolMessageType('ValidationRuleDefinition', (_message.Message,), {'DESCRIPTOR': _VALIDATIONRULEDEFINITION, '__module__': 'common.validation_service_pb2'})
_sym_db.RegisterMessage(ValidationRuleDefinition)
GetValidationRuleResponse = _reflection.GeneratedProtocolMessageType('GetValidationRuleResponse', (_message.Message,), {'DESCRIPTOR': _GETVALIDATIONRULERESPONSE, '__module__': 'common.validation_service_pb2'})
_sym_db.RegisterMessage(GetValidationRuleResponse)
GetGeneratedValidationRuleResponse = _reflection.GeneratedProtocolMessageType('GetGeneratedValidationRuleResponse', (_message.Message,), {'DESCRIPTOR': _GETGENERATEDVALIDATIONRULERESPONSE, '__module__': 'common.validation_service_pb2'})
_sym_db.RegisterMessage(GetGeneratedValidationRuleResponse)
RdlCheckRequest = _reflection.GeneratedProtocolMessageType('RdlCheckRequest', (_message.Message,), {'DESCRIPTOR': _RDLCHECKREQUEST, '__module__': 'common.validation_service_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _VALIDATIONRULEDEFINITION._serialized_start = 73
    _VALIDATIONRULEDEFINITION._serialized_end = 207
    _GETVALIDATIONRULERESPONSE._serialized_start = 209
    _GETVALIDATIONRULERESPONSE._serialized_end = 334
    _GETGENERATEDVALIDATIONRULERESPONSE._serialized_start = 336
    _GETGENERATEDVALIDATIONRULERESPONSE._serialized_end = 434
    _RDLCHECKREQUEST._serialized_start = 436
    _RDLCHECKREQUEST._serialized_end = 466