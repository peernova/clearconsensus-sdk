...
FileIdentifier = _reflection.GeneratedProtocolMessageType('FileIdentifier', (_message.Message,), {'DESCRIPTOR': _FILEIDENTIFIER, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileIdentifier)
FileDelimiterSetting = _reflection.GeneratedProtocolMessageType('FileDelimiterSetting', (_message.Message,), {'DESCRIPTOR': _FILEDELIMITERSETTING, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileDelimiterSetting)
SetFileDelimiterRequest = _reflection.GeneratedProtocolMessageType('SetFileDelimiterRequest', (_message.Message,), {'DESCRIPTOR': _SETFILEDELIMITERREQUEST, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(SetFileDelimiterRequest)
FilePreview = _reflection.GeneratedProtocolMessageType('FilePreview', (_message.Message,), {'DESCRIPTOR': _FILEPREVIEW, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FilePreview)
FileList = _reflection.GeneratedProtocolMessageType('FileList', (_message.Message,), {'DESCRIPTOR': _FILELIST, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileList)
FileDescriptorSetting = _reflection.GeneratedProtocolMessageType('FileDescriptorSetting', (_message.Message,), {'DESCRIPTOR': _FILEDESCRIPTORSETTING, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileDescriptorSetting)
SetFileDescriptorRequest = _reflection.GeneratedProtocolMessageType('SetFileDescriptorRequest', (_message.Message,), {'DESCRIPTOR': _SETFILEDESCRIPTORREQUEST, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(SetFileDescriptorRequest)
FileSubmissionRequest = _reflection.GeneratedProtocolMessageType('FileSubmissionRequest', (_message.Message,), {'DESCRIPTOR': _FILESUBMISSIONREQUEST, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileSubmissionRequest)
FileHistoryRequest = _reflection.GeneratedProtocolMessageType('FileHistoryRequest', (_message.Message,), {'DESCRIPTOR': _FILEHISTORYREQUEST, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileHistoryRequest)
FileHistoryResponse = _reflection.GeneratedProtocolMessageType('FileHistoryResponse', (_message.Message,), {'DESCRIPTOR': _FILEHISTORYRESPONSE, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileHistoryResponse)
FileHistoryResponseData = _reflection.GeneratedProtocolMessageType('FileHistoryResponseData', (_message.Message,), {'DESCRIPTOR': _FILEHISTORYRESPONSEDATA, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileHistoryResponseData)
FileHistoryRow = _reflection.GeneratedProtocolMessageType('FileHistoryRow', (_message.Message,), {'DESCRIPTOR': _FILEHISTORYROW, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(FileHistoryRow)
GetFileExportUrlRequest = _reflection.GeneratedProtocolMessageType('GetFileExportUrlRequest', (_message.Message,), {'DESCRIPTOR': _GETFILEEXPORTURLREQUEST, '__module__': 'common.file_pb2'})
_sym_db.RegisterMessage(GetFileExportUrlRequest)
GetFileExportUrlResponse = _reflection.GeneratedProtocolMessageType('GetFileExportUrlResponse', (_message.Message,), {'FileExportUrl': _reflection.GeneratedProtocolMessageType('FileExportUrl', (_message.Message,), {'DESCRIPTOR': _GETFILEEXPORTURLRESPONSE_FILEEXPORTURL, '__module__': 'common.file_pb2'}), 'DESCRIPTOR': _GETFILEEXPORTURLRESPONSE, '__module__': 'common.file_pb2'})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _EXPORTTYPE._serialized_start = 1816
    _EXPORTTYPE._serialized_end = 1995
    _FILEIDENTIFIER._serialized_start = 88
    _FILEIDENTIFIER._serialized_end = 164
    _FILEDELIMITERSETTING._serialized_start = 166
    _FILEDELIMITERSETTING._serialized_end = 235
    _SETFILEDELIMITERREQUEST._serialized_start = 238
    _SETFILEDELIMITERREQUEST._serialized_end = 373
    _FILEPREVIEW._serialized_start = 376
    _FILEPREVIEW._serialized_end = 550
    _FILELIST._serialized_start = 552
    _FILELIST._serialized_end = 605
    _FILEDESCRIPTORSETTING._serialized_start = 607
    _FILEDESCRIPTORSETTING._serialized_end = 655
    _SETFILEDESCRIPTORREQUEST._serialized_start = 658
    _SETFILEDESCRIPTORREQUEST._serialized_end = 796
    _FILESUBMISSIONREQUEST._serialized_start = 799
    _FILESUBMISSIONREQUEST._serialized_end = 944
    _FILEHISTORYREQUEST._serialized_start = 947
    _FILEHISTORYREQUEST._serialized_end = 1135
    _FILEHISTORYRESPONSE._serialized_start = 1137
    _FILEHISTORYRESPONSE._serialized_end = 1255
    _FILEHISTORYRESPONSEDATA._serialized_start = 1257
    _FILEHISTORYRESPONSEDATA._serialized_end = 1381
    _FILEHISTORYROW._serialized_start = 1384
    _FILEHISTORYROW._serialized_end = 1523
    _GETFILEEXPORTURLREQUEST._serialized_start = 1525
    _GETFILEEXPORTURLREQUEST._serialized_end = 1639
    _GETFILEEXPORTURLRESPONSE._serialized_start = 1642
    _GETFILEEXPORTURLRESPONSE._serialized_end = 1813
    _GETFILEEXPORTURLRESPONSE_FILEEXPORTURL._serialized_start = 1770
    _GETFILEEXPORTURLRESPONSE_FILEEXPORTURL._serialized_end = 1801