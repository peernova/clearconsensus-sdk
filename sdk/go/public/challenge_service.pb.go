...
var file_public_challenge_service_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x6e, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd5, 0x05, 0x0a, 0x10,
...
var file_public_challenge_service_proto_goTypes = []interface{}{
	...
	(*common.ChallengeFormMetaResponse)(nil),      // 5: titanium.ChallengeFormMetaResponse
	(*common.ChallengeCreateResponse)(nil),        // 6: titanium.ChallengeCreateResponse
	(*common.StatusResponse)(nil),                 // 7: titanium.StatusResponse
	(*common.GetChallengeDetailsResponse)(nil),    // 8: titanium.GetChallengeDetailsResponse
	(*common.GetAttachmentUploadUrlResponse)(nil), // 9: titanium.GetAttachmentUploadUrlResponse
}
var file_public_challenge_service_proto_depIdxs = []int32{
	...
	5, // 5: titanium.ChallengeService.ChallengeFormMeta:output_type -> titanium.ChallengeFormMetaResponse
	6, // 6: titanium.ChallengeService.ChallengeCreate:output_type -> titanium.ChallengeCreateResponse
	7, // 7: titanium.ChallengeService.ChallengeFreezeStatus:output_type -> titanium.StatusResponse
	8, // 8: titanium.ChallengeService.GetChallengeDetails:output_type -> titanium.GetChallengeDetailsResponse
	9, // 9: titanium.ChallengeService.GetChallengeAttachmentUploadUrl:output_type -> titanium.GetAttachmentUploadUrlResponse
