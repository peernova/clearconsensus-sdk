...
func (x *DtccTabRequest) GetGroupKeys() *common.ListOfKeys {
	if x, ok := x.GetId().(*DtccTabRequest_GroupKeys); ok {
		return x.GroupKeys
	}
	return nil
}
...
type DtccTabRequest_GroupKeys struct {
	GroupKeys *common.ListOfKeys `protobuf:"bytes,8,opt,name=group_keys,json=groupKeys,proto3,oneof"`
}

func (*DtccTabRequest_SubmissionId) isDtccTabRequest_Id() {}

func (*DtccTabRequest_GroupKeys) isDtccTabRequest_Id() {}
...
var file_public_dtcc_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd3, 0x02, 0x0a, 0x0e, 0x44, 0x74, 0x63, 0x63, 0x54, 0x61, 0x62,
	...
	0x0a, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x6b, 0x65, 0x79, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x14, 0x2e, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x69, 0x75, 0x6d, 0x2e, 0x4c, 0x69, 0x73,
	0x74, 0x4f, 0x66, 0x4b, 0x65, 0x79, 0x73, 0x48, 0x00, 0x52, 0x09, 0x67, 0x72, 0x6f, 0x75, 0x70,
	0x4b, 0x65, 0x79, 0x73, 0x42, 0x04, 0x0a, 0x02, 0x69, 0x64, 0x22, 0x7b, 0x0a, 0x0f, 0x44, 0x74,
	0x63, 0x63, 0x54, 0x61, 0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33, 0x0a,
	0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x74, 0x69,
	0x74, 0x61, 0x6e, 0x69, 0x75, 0x6d, 0x2e, 0x44, 0x74, 0x63, 0x63, 0x54, 0x61, 0x62, 0x52, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x92, 0x01, 0x0a, 0x13, 0x44, 0x74, 0x63, 0x63,
	0x54, 0x61, 0x62, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	,
...
var file_public_dtcc_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_public_dtcc_proto_goTypes = []interface{}{
	(*DtccTabRequest)(nil),      // 0: titanium.DtccTabRequest
	(*DtccTabResponse)(nil),     // 1: titanium.DtccTabResponse
	(*DtccTabResponseData)(nil), // 2: titanium.DtccTabResponseData
	(*common.FilterPack)(nil),   // 3: titanium.FilterPack
	(*common.OrderBy)(nil),      // 4: titanium.OrderBy
	(*common.Page)(nil),         // 5: titanium.Page
	(*common.ListOfKeys)(nil),   // 6: titanium.ListOfKeys
...
var file_public_dtcc_proto_depIdxs = []int32{
	3,  // 0: titanium.DtccTabRequest.filter_pack:type_name -> titanium.FilterPack
	4,  // 1: titanium.DtccTabRequest.orderBy:type_name -> titanium.OrderBy
	5,  // 2: titanium.DtccTabRequest.page:type_name -> titanium.Page
	6,  // 3: titanium.DtccTabRequest.group_keys:type_name -> titanium.ListOfKeys
	2,  // 4: titanium.DtccTabResponse.data:type_name -> titanium.DtccTabResponseData
	7,  // 5: titanium.DtccTabResponse.error:type_name -> titanium.Error
	8,  // 6: titanium.DtccTabResponseData.columns:type_name -> titanium.ColumnInfo
	9,  // 7: titanium.DtccTabResponseData.rows:type_name -> titanium.ValuesRow
	5,  // 8: titanium.DtccTabResponseData.page:type_name -> titanium.Page
	0,  // 9: titanium.DtccService.GetDtccTable:input_type -> titanium.DtccTabRequest
	1,  // 10: titanium.DtccService.GetDtccTable:output_type -> titanium.DtccTabResponse
...
func file_public_dtcc_proto_init() {
	...
	file_public_dtcc_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*DtccTabRequest_GroupKeys)(nil),
	}
	file_public_dtcc_proto_msgTypes[1].OneofWrappers = []interface{}{
