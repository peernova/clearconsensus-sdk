...
const (
	TabDataType_TABLE          TabDataType = 0
	TabDataType_COLLAPSE_TABLE TabDataType = 1
)

// Enum value maps for TabDataType.
var (
	TabDataType_name = map[int32]string{
		0: "TABLE",
		1: "COLLAPSE_TABLE",
	}
	TabDataType_value = map[string]int32{
		"TABLE":          0,
		"COLLAPSE_TABLE": 1,
	}
)

func (x TabDataType) Enum() *TabDataType {
	p := new(TabDataType)
	*p = x
	return p
}

func (x TabDataType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TabDataType) Descriptor() protoreflect.EnumDescriptor {
	return file_common_data_proto_enumTypes[0].Descriptor()
}

func (TabDataType) Type() protoreflect.EnumType {
	return &file_common_data_proto_enumTypes[0]
}

func (x TabDataType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TabDataType.Descriptor instead.
func (TabDataType) EnumDescriptor() ([]byte, []int) {
...
func (Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_common_data_proto_enumTypes[2].Descriptor()
}

func (Protocol) Type() protoreflect.EnumType {
	return &file_common_data_proto_enumTypes[2]
}
...
type SubmittedRequest struct {
	...
	DataType              TabDataType `protobuf:"varint,5,opt,name=data_type,json=dataType,proto3,enum=titanium.TabDataType" json:"data_type,omitempty"`
	// Types that are assignable to SearchConfiguration:
	//
	//	*SubmittedRequest_TableConfig
	//	*SubmittedRequest_CollapseTableConfig
	SearchConfiguration isSubmittedRequest_SearchConfiguration `protobuf_oneof:"search_configuration"`
}
...
func (x *SubmittedRequest) GetDataType() TabDataType {
	if x != nil {
		return x.DataType
	}
	return TabDataType_TABLE
}

func (m *SubmittedRequest) GetSearchConfiguration() isSubmittedRequest_SearchConfiguration {
	if m != nil {
...
func (x *SubmittedRequest) GetTableConfig() *TableRequest {
	if x, ok := x.GetSearchConfiguration().(*SubmittedRequest_TableConfig); ok {
		return x.TableConfig
	}
	return nil
}

func (x *SubmittedRequest) GetCollapseTableConfig() *CollapseTableRequest {
	if x, ok := x.GetSearchConfiguration().(*SubmittedRequest_CollapseTableConfig); ok {
		return x.CollapseTableConfig
	}
	return nil
}

type isSubmittedRequest_SearchConfiguration interface {
	isSubmittedRequest_SearchConfiguration()
}

type SubmittedRequest_TableConfig struct {
	TableConfig *TableRequest `protobuf:"bytes,6,opt,name=table_config,json=tableConfig,proto3,oneof"`
}

type SubmittedRequest_CollapseTableConfig struct {
	CollapseTableConfig *CollapseTableRequest `protobuf:"bytes,7,opt,name=collapse_table_config,json=collapseTableConfig,proto3,oneof"`
}

func (*SubmittedRequest_TableConfig) isSubmittedRequest_SearchConfiguration() {}

func (*SubmittedRequest_CollapseTableConfig) isSubmittedRequest_SearchConfiguration() {}
...
type TableRequest struct {
	...
	OrderBy    *OrderBy    `protobuf:"bytes,8,opt,name=orderBy,proto3" json:"orderBy,omitempty"`
...
func (x *TableRequest) GetFilters() []*Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
func (x *TableRequest) GetFilterPack() *FilterPack {
	if x != nil {
		return x.FilterPack
	}
	return nil
...
func (x *TableRequest) GetOrderBy() *OrderBy {
	if x != nil {
		return x.OrderBy
	}
	return nil
...
func (x *TableRequest) GetPage() *Page {
	if x != nil {
		return x.Page
	}
	return nil
...
type CollapseTableRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CollapseTableRequest) Reset() {
	*x = CollapseTableRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollapseTableRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollapseTableRequest) ProtoMessage() {}

func (x *CollapseTableRequest) ProtoReflect() protoreflect.Message {
	mi := &file_common_data_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollapseTableRequest.ProtoReflect.Descriptor instead.
func (*CollapseTableRequest) Descriptor() ([]byte, []int) {
	return file_common_data_proto_rawDescGZIP(), []int{4}
}

func (x *CollapseTableRequest) GetFilters() []*Filter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type FileAnnotation struct {
	...
	UploadTime string           `protobuf:"bytes,2,opt,name=upload_time,json=uploadTime,proto3" json:"upload_time,omitempty"`
	Mode       UploadMode       `protobuf:"varint,3,opt,name=mode,proto3,enum=titanium.UploadMode" json:"mode,omitempty"`
	Client     string           `protobuf:"bytes,4,opt,name=client,proto3" json:"client,omitempty"`
	Asset      *AssetDetails    `protobuf:"bytes,5,opt,name=asset,proto3" json:"asset,omitempty"`
	Chunks     []*Chunk         `protobuf:"bytes,6,rep,name=chunks,proto3" json:"chunks,omitempty"`
	Annotation *structpb.Struct `protobuf:"bytes,7,opt,name=annotation,proto3" json:"annotation,omitempty"`
}
...
func (x *FileAnnotation) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
func (x *FileAnnotation) GetUploadTime() string {
	if x != nil {
		return x.UploadTime
	}
	return ""
...
func (x *FileAnnotation) GetMode() UploadMode {
	if x != nil {
		return x.Mode
	}
...
func (x *FileAnnotation) GetClient() string {
	if x != nil {
		return x.Client
	}
	return ""
...
func (x *FileAnnotation) GetAsset() *AssetDetails {
	if x != nil {
		return x.Asset
	}
	return nil
...
func (x *FileAnnotation) GetChunks() []*Chunk {
	if x != nil {
		return x.Chunks
	}
	return nil
...
func (x *FileAnnotation) GetAnnotation() *structpb.Struct {
	if x != nil {
		return x.Annotation
	}
	return nil
...
type Chunk struct {
	...
	StartRow         int32            `protobuf:"varint,5,opt,name=start_row,json=startRow,proto3" json:"start_row,omitempty"`
	RowsCount        int32            `protobuf:"varint,6,opt,name=rows_count,json=rowsCount,proto3" json:"rows_count,omitempty"`
	Annotation       *structpb.Struct `protobuf:"bytes,7,opt,name=annotation,proto3" json:"annotation,omitempty"`
}
...
func (x *Chunk) GetOriginalFileName() string {
	if x != nil {
...
func (x *Chunk) GetStartRow() int32 {
	if x != nil {
		return x.StartRow
	}
	return 0
...
func (x *Chunk) GetRowsCount() int32 {
	if x != nil {
		return x.RowsCount
	}
	return 0
...
func (x *Chunk) GetAnnotation() *structpb.Struct {
	if x != nil {
		return x.Annotation
	}
	return nil
...
func (*CompleteDataUploadRequest) Descriptor() ([]byte, []int) {
	return file_common_data_proto_rawDescGZIP(), []int{17}
}
...
func (x *CompleteDataUploadResponse) Reset() {
	*x = CompleteDataUploadResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_data_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CompleteDataUploadResponse) Descriptor() ([]byte, []int) {
	return file_common_data_proto_rawDescGZIP(), []int{18}
}
...
type UploadDataRequest struct {
	...
	Client      string           `protobuf:"bytes,1,opt,name=client,proto3" json:"client,omitempty"`
	FileName    string           `protobuf:"bytes,2,opt,name=file_name,json=fileName,proto3" json:"file_name,omitempty"`
	Protocol    Protocol         `protobuf:"varint,3,opt,name=protocol,proto3,enum=titanium.Protocol" json:"protocol,omitempty"`
	Mode        UploadMode       `protobuf:"varint,4,opt,name=mode,proto3,enum=titanium.UploadMode" json:"mode,omitempty"`
	Asset       *AssetDetails    `protobuf:"bytes,5,opt,name=asset,proto3" json:"asset,omitempty"`
...
func (x *UploadDataRequest) Reset() {
	*x = UploadDataRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_data_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UploadDataRequest) Descriptor() ([]byte, []int) {
	return file_common_data_proto_rawDescGZIP(), []int{19}
}
...
func (x *UploadDataRequest) GetMode() UploadMode {
	if x != nil {
		return x.Mode
	}
	return UploadMode_SUBMISSION
...
func (x *UploadDataRequest) GetAsset() *AssetDetails {
	if x != nil {
		return x.Asset
	}
	return nil
...
func (x *UploadDataRequest) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *UploadDataRequest) GetAnnotation() *structpb.Struct {
	if x != nil {
		return x.Annotation
	}
	return nil
...
type AssetDetails struct {
	...
	SubAsset string `protobuf:"bytes,3,opt,name=sub_asset,json=subAsset,proto3" json:"sub_asset,omitempty"`
...
func (x *AssetDetails) Reset() {
	*x = AssetDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_data_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetDetails) Descriptor() ([]byte, []int) {
	return file_common_data_proto_rawDescGZIP(), []int{20}
}

func (x *AssetDetails) GetAssetId() string {
	if x != nil {
		return x.AssetId
	}
	return ""
...
func (x *AssetDetails) GetSubAsset() string {
	if x != nil {
		return x.SubAsset
	}
	return ""
...
func (x *AssetDetails) GetService() string {
	if x != nil {
		return x.Service
	}
	return ""
...
func (x *AssetDetails) GetSnapTime() string {
	if x != nil {
		return x.SnapTime
	}
	return ""
...
func (x *AssetDetails) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
func (x *Annotation) Reset() {
	*x = Annotation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_data_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Annotation) Descriptor() ([]byte, []int) {
	return file_common_data_proto_rawDescGZIP(), []int{21}
}
...
var file_common_data_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x74, 0x68, 0x22, 0x8a, 0x03, 0x0a, 0x10, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x74,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x74, 0x61, 0x6e, 0x69, 0x75, 0x6d, 0x2e, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x74,
	0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x48, 0x00,
	...
	0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x97, 0x01, 0x0a, 0x15,
	0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x12, 0x2a, 0x0a, 0x04, 0x72, 0x6f, 0x77, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x69, 0x75, 0x6d, 0x2e, 0x53,
	0x75, 0x62, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x52, 0x6f, 0x77, 0x52, 0x04, 0x72, 0x6f, 0x77,
	...
	0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0xbe, 0x01, 0x0a, 0x0c, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74,
	0x74, 0x65, 0x64, 0x52, 0x6f, 0x77, 0x12, 0x2e, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73,
	...
	,
	...
	0x74, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x75, 0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x75,
	0x62, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x65, 0x12, 0x36, 0x0a, 0x17,
	...
	0x74, 0x61, 0x6d, 0x70, 0x12, 0x25, 0x0a, 0x0e, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x5f,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x69, 0x6e,
	0x63, 0x6c, 0x75, 0x64, 0x65, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x35, 0x0a, 0x0b, 0x66,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x5f, 0x70, 0x61, 0x63, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x63, 0x6b, 0x12, 0x2a, 0x0a, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x06, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x69, 0x75, 0x6d, 0x2e, 0x46,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x12, 0x2b,
	...
	0x09, 0x74, 0x72, 0x61, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x87, 0x01, 0x0a, 0x13, 0x45,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x73, 0x73, 0x65, 0x74, 0x49, 0x64, 0x12, 0x36, 0x0a,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x63, 0x65, 0x5f, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x72, 0x61, 0x63, 0x65,
	0x4e, 0x61, 0x6d, 0x65, 0x22, 0x8d, 0x01, 0x0a, 0x0e, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x46, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x69, 0x75, 0x6d,
	0x2e, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x50, 0x72, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64,
	0x55, 0x72, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x8d, 0x01, 0x0a, 0x26, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x50,
	0x72, 0x65, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x55, 0x72, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x24, 0x0a, 0x0d, 0x67, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x55, 0x72, 0x6c,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x67, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x55, 0x72, 0x6c, 0x12, 0x1b, 0x0a, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x6e, 0x61,
	...
	0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x22, 0x62, 0x0a, 0x12, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65,
	...
	0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x81, 0x02, 0x0a, 0x10, 0x55, 0x70, 0x6c,
	...
	0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6c, 0x69,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x72, 0x61, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65,
	...
	0x0e, 0x46, 0x69, 0x6c, 0x65, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	,
	...
	0x74, 0x5f, 0x72, 0x6f, 0x77, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x52, 0x6f, 0x77, 0x12, 0x1d, 0x0a, 0x0a, 0x72, 0x6f, 0x77, 0x73, 0x5f, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x72, 0x6f, 0x77, 0x73, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x37, 0x0a, 0x0a, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63,
	0x74, 0x52, 0x0a, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x85, 0x01,
	...
	0x6e, 0x73, 0x65, 0x22, 0xab, 0x02, 0x0a, 0x11, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x61,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x75, 0x62, 0x5f, 0x61, 0x73, 0x73, 0x65, 0x74,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x75, 0x62, 0x41, 0x73, 0x73, 0x65, 0x74,
	0x12, 0x18, 0x0a, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x6e,
	0x61, 0x70, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73,
	0x6e, 0x61, 0x70, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x65, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x64,
	...
	,
...
var file_common_data_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_common_data_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_common_data_proto_goTypes = []interface{}{
	(TabDataType)(0),                               // 0: titanium.TabDataType
	(UploadMode)(0),                                // 1: titanium.UploadMode
	(Protocol)(0),                                  // 2: titanium.Protocol
	(*UploadAuthorizationResponse)(nil),            // 3: titanium.UploadAuthorizationResponse
	(*UploadNotifyRequest)(nil),                    // 4: titanium.UploadNotifyRequest
	(*SubmittedRequest)(nil),                       // 5: titanium.SubmittedRequest
	(*TableRequest)(nil),                           // 6: titanium.TableRequest
	(*CollapseTableRequest)(nil),                   // 7: titanium.CollapseTableRequest
	(*SubmittedResponse)(nil),                      // 8: titanium.SubmittedResponse
	(*SubmittedResponseData)(nil),                  // 9: titanium.SubmittedResponseData
	(*SubmittedRow)(nil),                           // 10: titanium.SubmittedRow
	(*ExportRequest)(nil),                          // 11: titanium.ExportRequest
	(*ExportReportRequest)(nil),                    // 12: titanium.ExportReportRequest
	(*ExportResponse)(nil),                         // 13: titanium.ExportResponse
	(*ExportPresignedUrlResponseResponseData)(nil), // 14: titanium.ExportPresignedUrlResponseResponseData
	(*ExportResponseData)(nil),                     // 15: titanium.ExportResponseData
	(*UploadURLRequest)(nil),                       // 16: titanium.UploadURLRequest
	(*FileAnnotation)(nil),                         // 17: titanium.FileAnnotation
	(*Chunk)(nil),                                  // 18: titanium.Chunk
	(*UploadDataResponse)(nil),                     // 19: titanium.UploadDataResponse
	(*CompleteDataUploadRequest)(nil),              // 20: titanium.CompleteDataUploadRequest
	(*CompleteDataUploadResponse)(nil),             // 21: titanium.CompleteDataUploadResponse
	(*UploadDataRequest)(nil),                      // 22: titanium.UploadDataRequest
	(*AssetDetails)(nil),                           // 23: titanium.AssetDetails
	(*Annotation)(nil),                             // 24: titanium.Annotation
	(*Filter)(nil),                                 // 25: titanium.Filter
	(*FilterPack)(nil),                             // 26: titanium.FilterPack
	(*OrderBy)(nil),                                // 27: titanium.OrderBy
	(*Page)(nil),                                   // 28: titanium.Page
	(*Error)(nil),                                  // 29: titanium.Error
	(*ColumnInfo)(nil),                             // 30: titanium.ColumnInfo
	(*structpb.Value)(nil),                         // 31: google.protobuf.Value
	(*structpb.Struct)(nil),                        // 32: google.protobuf.Struct
}
var file_common_data_proto_depIdxs = []int32{
	0,  // 0: titanium.SubmittedRequest.data_type:type_name -> titanium.TabDataType
	6,  // 1: titanium.SubmittedRequest.table_config:type_name -> titanium.TableRequest
	7,  // 2: titanium.SubmittedRequest.collapse_table_config:type_name -> titanium.CollapseTableRequest
	25, // 3: titanium.TableRequest.filters:type_name -> titanium.Filter
	26, // 4: titanium.TableRequest.filter_pack:type_name -> titanium.FilterPack
	27, // 5: titanium.TableRequest.orderBy:type_name -> titanium.OrderBy
	28, // 6: titanium.TableRequest.page:type_name -> titanium.Page
	25, // 7: titanium.CollapseTableRequest.filters:type_name -> titanium.Filter
	9,  // 8: titanium.SubmittedResponse.data:type_name -> titanium.SubmittedResponseData
	29, // 9: titanium.SubmittedResponse.error:type_name -> titanium.Error
	30, // 10: titanium.SubmittedResponseData.columns:type_name -> titanium.ColumnInfo
	10, // 11: titanium.SubmittedResponseData.rows:type_name -> titanium.SubmittedRow
	28, // 12: titanium.SubmittedResponseData.page:type_name -> titanium.Page
	31, // 13: titanium.SubmittedRow.values:type_name -> google.protobuf.Value
	26, // 14: titanium.ExportRequest.filter_pack:type_name -> titanium.FilterPack
	25, // 15: titanium.ExportRequest.filters:type_name -> titanium.Filter
	27, // 16: titanium.ExportRequest.orderBy:type_name -> titanium.OrderBy
	14, // 17: titanium.ExportResponse.data:type_name -> titanium.ExportPresignedUrlResponseResponseData
	29, // 18: titanium.ExportResponse.error:type_name -> titanium.Error
	17, // 19: titanium.UploadURLRequest.file_annotation:type_name -> titanium.FileAnnotation
	1,  // 20: titanium.FileAnnotation.mode:type_name -> titanium.UploadMode
	23, // 21: titanium.FileAnnotation.asset:type_name -> titanium.AssetDetails
	18, // 22: titanium.FileAnnotation.chunks:type_name -> titanium.Chunk
	32, // 23: titanium.FileAnnotation.annotation:type_name -> google.protobuf.Struct
	32, // 24: titanium.Chunk.annotation:type_name -> google.protobuf.Struct
	29, // 25: titanium.UploadDataResponse.error:type_name -> titanium.Error
	29, // 26: titanium.CompleteDataUploadResponse.error:type_name -> titanium.Error
	2,  // 27: titanium.UploadDataRequest.protocol:type_name -> titanium.Protocol
	1,  // 28: titanium.UploadDataRequest.mode:type_name -> titanium.UploadMode
	23, // 29: titanium.UploadDataRequest.asset:type_name -> titanium.AssetDetails
	32, // 30: titanium.UploadDataRequest.annotation:type_name -> google.protobuf.Struct
	1,  // 31: titanium.Annotation.mode:type_name -> titanium.UploadMode
	32, // 32: titanium.Annotation.annotations:type_name -> google.protobuf.Struct
...
func file_common_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_data_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CollapseTableRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_common_data_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_data_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_data_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_data_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_data_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*SubmittedRequest_TableConfig)(nil),
		(*SubmittedRequest_CollapseTableConfig)(nil),
	}
	...
	file_common_data_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*ExportResponse_Data)(nil),
		(*ExportResponse_Error)(nil),
	}
	file_common_data_proto_msgTypes[16].OneofWrappers = []interface{}{
		(*UploadDataResponse_S3Url)(nil),
		(*UploadDataResponse_Error)(nil),
		(*UploadDataResponse_TusPayload)(nil),
	}
	file_common_data_proto_msgTypes[18].OneofWrappers = []interface{}{
