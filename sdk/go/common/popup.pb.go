...
var file_common_popup_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x42, 0x73, 0x0a, 0x20, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x65, 0x65, 0x72, 0x6e, 0x6f,
	0x76, 0x61, 0x2e, 0x74, 0x69, 0x74, 0x61, 0x6e, 0x69, 0x75, 0x6d, 0x2e, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x66, 0x61, 0x63, 0x65, 0x73, 0x42, 0x17, 0x50, 0x6f, 0x70, 0x55, 0x70, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x50,
...
var file_common_popup_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_common_popup_proto_goTypes = []interface{}{
	...
	(*ConsensusDetail)(nil),       // 5: titanium.ConsensusDetail
	(*DataQualityErrors)(nil),     // 6: titanium.DataQualityErrors
	(*StringKeyVal)(nil),          // 7: titanium.StringKeyVal
	(*ColumnInfo)(nil),            // 8: titanium.ColumnInfo
...
var file_common_popup_proto_depIdxs = []int32{
	...
	4,  // 1: titanium.PopUpViewResponse.error:type_name -> titanium.Error
	...
	5,  // 5: titanium.PopUpViewResponseData.consensusDetails:type_name -> titanium.ConsensusDetail
	6,  // 6: titanium.PopUpViewResponseData.dataQualityErrors:type_name -> titanium.DataQualityErrors
	7,  // 7: titanium.PopUpViewResponseData.grouping_keys:type_name -> titanium.StringKeyVal
	8,  // 8: titanium.ViewRow.columns:type_name -> titanium.ColumnInfo
	9,  // 9: titanium.ViewRow.values:type_name -> google.protobuf.Value
